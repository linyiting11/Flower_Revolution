...
function setup() {
  ...
  rSlider.position(1200, 560);
  gSlider = createSlider(0, 255, 220);
  gSlider.position(1200, 580);
  bSlider = createSlider(0, 255, 210);
  bSlider.position(1200, 600);
...
function draw() {
  ...
  fill(255, 255, 255)
  text("Set Off", 100, 150)
  text("Your own", 100, 200)
  text("Revolution", 100,250)
  ...
  textStyle(BOLD)
  fill(255, 255, 255)
  // text("LOOK TIPS", 100, 480)
  text("PARTICIPATION", 980, 220)
  text("CAUALTIES", 980,300)
  text("ARRESTS", 980, 380)
  text("MISSING PEOPLE", 980, 460)
  text("ECONOMIC IMPACT", 980, 540)
  text("TIME", 1200 , 220)
  text("RED", 1200, 300)
  text("YELLOW", 1200, 380)
  text("BLUE", 1200, 460)
  text("BACK GROUND(RGB)",1200,540)
  
  
  //if(mouseY > 450)
  //if(mouseX < 200) {
  //image(rule, width/ 14, height/ 1.5, 380, 200)
  //}
